...
const REQUIRED_SCHEMA_COLUMNS: readonly RequiredSchemaColumn[] = [
  ...
  {
    tableName: "subscriptions",
    columnName: "provider_checkout_id",
    isNullable: "YES",
    dataType: "text",
    udtName: "text",
  },
...
const REQUIRED_SCHEMA_INDEXES = [
  ...
  {
    indexName: "subscription_plans_code_unique",
    tableName: "subscription_plans",
    columns: ["code"],
  },
  {
    indexName: "payment_events_provider_event_transaction_unique",
    tableName: "payment_events",
    columns: ["provider", "event_type", "provider_transaction_id"],
  },
] as const;
